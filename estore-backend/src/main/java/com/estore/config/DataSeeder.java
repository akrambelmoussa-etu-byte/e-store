    ...
    private void seedRelational() {
        ...
        List<Product> products = List.of(
                buildProduct("Ordinateur portable Dell XPS 13", "Intel i7, 16 Go RAM, SSD 512 Go",
                        new BigDecimal("12500.00"), "https://placehold.co/400x300?text=Dell+XPS", informatique),
                buildProduct("Clavier mécanique Logitech G Pro", "Switches GX Blue, RGB",
                        new BigDecimal("1450.00"), "https://placehold.co/400x300?text=Logitech+G", informatique),
                buildProduct("Souris Logitech MX Master 3", "Sans fil, ergonomique",
                        new BigDecimal("950.00"), "https://placehold.co/400x300?text=MX+Master", informatique),
                buildProduct("Écran Dell 27\" 4K", "UltraSharp U2723QE",
                        new BigDecimal("4800.00"), "https://placehold.co/400x300?text=Dell+27%22", informatique),

                buildProduct("Clean Code", "Robert C. Martin — guide d'écriture de code propre",
                        new BigDecimal("320.00"), "https://placehold.co/400x300?text=Clean+Code", livres),
                buildProduct("Le Petit Prince", "Antoine de Saint-Exupéry, édition illustrée",
                        new BigDecimal("85.00"), "https://placehold.co/400x300?text=Le+Petit+Prince", livres),
                buildProduct("Sapiens", "Yuval Noah Harari — Une brève histoire de l'humanité",
                        new BigDecimal("180.00"), "https://placehold.co/400x300?text=Sapiens", livres),
                buildProduct("Spring Boot in Action", "Craig Walls — manuel de référence Spring Boot",
                        new BigDecimal("420.00"), "https://placehold.co/400x300?text=Spring+Boot", livres),

                buildProduct("Ballon de football Adidas", "Taille 5, officiel",
                        new BigDecimal("250.00"), "https://placehold.co/400x300?text=Adidas+Football", sport),
                buildProduct("Raquette de tennis Wilson Pro", "Pour joueurs intermédiaires",
                        new BigDecimal("780.00"), "https://placehold.co/400x300?text=Wilson+Pro", sport),
                buildProduct("Tapis de yoga premium", "6mm, antidérapant",
                        new BigDecimal("220.00"), "https://placehold.co/400x300?text=Yoga+Mat", sport),
                buildProduct("Haltères 10 kg (paire)", "Caoutchouc, hexagonaux",
                        new BigDecimal("450.00"), "https://placehold.co/400x300?text=Halteres", sport)
        );
